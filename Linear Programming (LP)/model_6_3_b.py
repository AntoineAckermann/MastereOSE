...
new_demand = [17, 15, 14, 13, 13, 18, 29, 32, 29, 27, 25, 25, 24, 24, 25, 38, 42, 40, 33, 31, 27, 26, 24, 21]

periods_discretized = {f"{t}h-{t + 1}h": [new_demand[t]*1e3, 1] for t in range(len(new_demand))}
