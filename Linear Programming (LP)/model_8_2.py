...
data_thermal = {"A": ["thermal", 12, 850, 2000, 2000, 1000, 2.0, 400, 1000],  # Type, N, Pmin, Pmax, Cstart, Cbase, Cmwh, ramp_limit, start_limit
                "B": ["thermal", 10, 1250, 1750, 1000, 2600, 1.3, 600, 1500],
                "C": ["thermal", 5, 1500, 4000, 500, 3000, 3, 800, 2000]}
...
data_thermal = pd.DataFrame.from_dict(data_thermal, orient='index',
                                      columns=["Type", "N", "Pmin", "Pmax", "Cstart", "Cbase", "Cmwh", "RampUpMax", "RampStart"])
